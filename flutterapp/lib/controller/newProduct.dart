...
/**
 * Aggiunge un nuovo prodotto da comprare in un gruppo
 */
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void addProdotto() {
    ...
    Prodotto prodotto = Prodotto(
        ...
        dropdownValuequantita,
        note.text.toString(),
        user!.uid.toString(),
        user!.displayName.toString(),
        "0");
    String idproduct =
        myRef.child(idgroup).child("prodotti").push().key.toString();
    myRef
        .child(idgroup)
        .child("prodotti")
        .child(idproduct)
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ListOfProduct(idgroup: idgroup)));
        },
        child: Text("Aggiungi",
